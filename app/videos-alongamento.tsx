...
const STRETCH_VIDEOS: StretchVideo[] = [
  {
    id: "1",
    title: "Alongamento de Costas - Básico",
    duration: "2 min",
    category: ["costas", "todos"],
    description: "Alongamento suave para aliviar tensão nas costas. Ideal para pausas rápidas.",
    thumbnail: "🧘",
  ...
  },
  {
    ...
    description: "Exercício para soltar os ombros e melhorar postura.",
    thumbnail: "💪",
    difficulty: "fácil",
  ...
  },
  {
    ...
    description: "Alongamento completo para quadríceps, posterior e panturrilha.",
    thumbnail: "🦵",
    difficulty: "médio",
  ...
  },
  {
    ...
    duration: "2 min",
    category: ["pescoço", "todos"],
    description: "Alívio rápido para tensão no pescoço e trapézio.",
    thumbnail: "🙆",
    difficulty: "fácil",
  ...
  },
  {
    ...
    duration: "5 min",
    category: ["todos"],
    description: "Rotina completa de alongamento para todo o corpo.",
    thumbnail: "🧘‍♂️",
    difficulty: "médio",
  ...
  },
  {
    ...
    duration: "4 min",
    category: ["costas"],
    description: "Alongamento profundo para costas com maior amplitude de movimento.",
    thumbnail: "🤸",
    difficulty: "avançado",
  ...
  },
  {
    ...
    duration: "3 min",
    category: ["ombros"],
    description: "Alongamento para ombros, braços e punhos.",
    thumbnail: "💪",
    difficulty: "fácil",
  ...
  {
    id: "8",
    title: "Pernas e Quadril",
    duration: "4 min",
    category: ["pernas"],
    description: "Alongamento focado em quadril, glúteos e pernas.",
    thumbnail: "🦵",
    difficulty: "médio",
